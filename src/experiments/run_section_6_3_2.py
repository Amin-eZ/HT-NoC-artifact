...
def main():
    ...
    config_dir = root / "configs" / "section_6_3_2"
    out_dir = root / "outputs" / "section_6_3_2" / "tables"
    out_dir.mkdir(parents=True, exist_ok=True)

    config_files = [
        config_dir / "vit_base_32x32.json",
        config_dir / "transformer_64x64.json",
    ]
    ...
    save_csv(all_rows, out_dir / "section_6_3_2_breakdown.csv")
    save_json(all_results, out_dir / "section_6_3_2_breakdown.json")

    print("Generated:")
    print(out_dir / "section_6_3_2_breakdown.csv")
    print(out_dir / "section_6_3_2_breakdown.json")
